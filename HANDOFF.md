...
- ~~Pasar el número WhatsApp de **modo test a live** en Meta~~ **✅ HECHO 2026-07-28** (app "Aria DPG" cambió a modo producción, confirmado en Meta for Developers → Alertas: "Aria DPG se cambió al modo activo el 28 jul., 2026"). Junto con el retiro del gate `WA_ECHO_ALLOWLIST` en `app/webhooks/meta.py` (commit `8f6a258`), el bot ya no está limitado a los 5 números de prueba.
